...
member_shell_start($pdo, ['title' => $pageTitle, 'page' => $currentPage, 'section' => e($leaderboard['club_name'])]);
?>
<style>
  :root { 
    --gold: #ffd700;
  ...
  .hero-section {
    background: linear-gradient(135deg, var(--primary-dark, #1e3a5f) 0%, var(--primary, #2d5a87) 100%);
    color: white;
    padding: 2rem;
  ...
  .leaderboard-table .score-cell { font-weight: bold; color: var(--primary-dark, #1e3a5f); }
...
<div class="mb-3">
  <a href="/public/club.php?slug=<?= e($leaderboard['club_slug']) ?>" class="btn btn-outline-secondary btn-sm">Back to Club</a>
</div>
