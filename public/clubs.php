  ...
  <div class="container">
    ...
    <div class="ms-auto">
      <?php if ($isLoggedIn): ?>
        ...
        <a class="btn btn-outline-light btn-sm ms-2" href="/public/auth/logout.php">Logout</a>
      <?php else: ?>
        <a class="btn btn-outline-light btn-sm" href="/">Log In</a>
        <a class="btn btn-primary btn-sm ms-2" href="/public/auth/register.php">Sign Up</a>
      <?php endif; ?>
    </div>
  </div>
</nav>
